"""
Django settings for maplas project.
...
WSGI_APPLICATION = 'maplas.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.environ.get('DATABASE_DIR'), 'db.sqlite3'),
    }
}
...
STRAVA_HEATMAP_TILE_DIR = os.environ.get('STRAVA_HEATMAP_TILE_DIR')