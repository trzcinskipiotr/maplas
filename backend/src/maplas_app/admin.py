...
class TrackAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'description', 'color', 'style', 'start_time', 'end_time', 'distance', 'status', 'type', 'upload_user')
...
class TrackDetailsAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'description', 'color', 'style', 'start_time', 'end_time', 'distance', 'status', 'type', 'get_points_json_counts', 'get_points_json_optimized_counts', 'get_gpx_file_counts', 'upload_user')
    search_fields = ('id', 'name', 'description', 'color', 'points_json')
