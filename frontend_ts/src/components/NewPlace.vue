      ...
      <info-modal :title="$t('newPlace')">
            ...
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="coordinatesRadio2" value=1 id="coordsradio1" v-model="coordinatesRadio">
                  <label class="form-check-label" for="coordsradio1">
                    {{ $t('manually') }}
                  </label>
                </div>
                ...
                <div class="form-check disabled">
                  <input :disabled="! firstPhotoLat" class="form-check-input" type="radio" name="coordinatesRadio2" id="coordsradio3" value="3" v-model="coordinatesRadio">
                  <label class="form-check-label" for="coordsradio3">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" :disabled="(((!name) || (!savePlaceType)) || (placeSaving))" @click="saveNewPlaceModal">
            <template v-if="placeSaving"><font-awesome-icon class="fa-spin" icon="spinner" />&nbsp;</template><strong>{{ $t('addPlaceToMap') }}</strong>
          </button>
...
@Component
export default class NewPlace extends BaseComponent {
