...
export default class GpsTrack {
    ...
    constructor(public id: number, public name: string, public description: string, public points_json_optimized: string, public color: string, public distance: number, public status: TrackStatus, public type: TrackType, public startTime: Date, public endTime: Date, public place: string) {
      this.pointsArray = [];
